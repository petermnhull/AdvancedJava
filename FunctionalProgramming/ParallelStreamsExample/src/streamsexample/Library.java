...
public class Library {
    ...
    public static void main(String[] args) {
        ...
        /* 
           Use multiple cores at the same time to implement
           Easy, would be very difficult with for loops.
           Simply change stream to parallelStream
        
           Get a much faster performance when using a large amount of data.
        */ 
